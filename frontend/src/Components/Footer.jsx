            ...
            <div className="row g-4 pb-5 border-bottom border-slate-700/60">
                <div className="col-md-3 d-flex flex-column gap-3">
                    ...
                    <div className="text-xs text-slate-300 d-flex flex-column gap-1">
                        <div>Email: <a href="mailto:support@eazeit.in" className="hover:text-teal-400 transition-colors text-decoration-none">support@eazeit.in</a></div>
                        <div>Phone: <a href="tel:+919876543210" className="hover:text-teal-400 transition-colors text-decoration-none">+91 98765 43210</a></div>
                        <div>Address: 12, Market Street, Chennai, TN - 600001</div>
                    </div>
                </div>
